...
import 'consult_card_core_widget/consult_duration_info_card_widget.dart';
import 'consult_card_core_widget/consultant_booking_section_card_widget.dart';
import 'consult_card_core_widget/consultant_doctor_avatar_card_widget.dart';
import 'consult_card_core_widget/consultant_info_section_card_widget.dart';

class ConsultantCard extends StatelessWidget {
  final ConsultantsEntity consultantsEntity;
  // final Function() onTap;
  const ConsultantCard({super.key, required this.consultantsEntity});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        context.push(PageRouteName.consultantIsDetailsView,extra: consultantsEntity.publicId ?? "");
      },
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
          color: Theme.of(context).cardColor, width: 1.w),
        ),
        child: Column(
